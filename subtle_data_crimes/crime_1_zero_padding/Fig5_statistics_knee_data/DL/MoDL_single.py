...
from subtle_data_crimes.crime_1_zero_padding.Fig5_statistics_knee_data.DL.utils.transforms import SenseModel_single
...
class UnrolledModel(nn.Module):
    ...
    def forward(self, kspace, init_image=None, mask=None):
        ...
        for resnet in self.resnets:
            ...
            CG_alg = ConjGrad(Aop_fun=Sense.normal, b=rhs, verbose=False, l2lam=self.modl_lamda,
                              max_iter=self.num_cg_steps)
